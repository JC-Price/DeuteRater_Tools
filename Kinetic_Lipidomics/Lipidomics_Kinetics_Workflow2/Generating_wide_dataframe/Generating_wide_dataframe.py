...
def main() -> None:
    ...
    metrics = [
        ...
        "BA_rate", "BA_Asyn", "BA_nL_SE", "BA_rate_SE", "BA_Asyn_SE","BA_R2",
        "n_value_SE", "n_value_dof",
    ...
    list_cols = [c for c in ["rate_graph_time_points_x", "normed_isotope_data_y", 'exponential_decay_pcov'] if c in rates.columns]
