...
echo ============================================
echo   Standardize_positive_and_negative_lipid_IDs – DEBUG MODE
echo ============================================
echo.
...
echo Running script: Standardize_positive_and_negative_lipid_IDs.py
echo --------------------------------------------
"%PYTHON_EXE%" "%SCRIPT_DIR%\Standardize_positive_and_negative_lipid_IDs.py" %*
