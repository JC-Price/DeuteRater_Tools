...
echo ============================================
echo   Concatenate_positive_and_negative – DEBUG MODE
echo ============================================
echo.
...
echo Running script: Concatenate_positive_and_negative.py
echo --------------------------------------------
"%PYTHON_EXE%" "%SCRIPT_DIR%\Concatenate_positive_and_negative.py" %*
