...
def main() -> None:
    ...
    metrics = [
        ...
        "BA_rate", "BA_Asyn", "BA_nL_SD", "BA_rate_SD", "BA_Asyn_SD", "n_value_SD", "n_value_dof"
    ]
    ...
    for exp in EXPERIMENTS:
        ...
        dr_cols_exp = [c for c in merged.columns if c.startswith("Abundance_") and c.endswith("DR")
