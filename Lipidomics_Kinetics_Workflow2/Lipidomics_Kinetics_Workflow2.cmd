...
echo ============================================
echo   Lipidomics_Kinetics_Workflow2 – DEBUG MODE
echo ============================================
echo.
...
if not exist "%PYTHON_EXE%" (
    ...
    echo %PYTHON_EXE%
    echo.
    echo Ensure your local python environment is set up properly. Consult README.txt.
    echo.
    goto :end
)
...
echo Running script: Lipidomics_Kinetics_Workflow2.py
echo --------------------------------------------
"%PYTHON_EXE%" "%SCRIPT_DIR%\Lipidomics_Kinetics_Workflow2.py" %*
