...
STEPS = [
    ...
    ("Concatenating Standardized Metadata", "07_concatenate_metadata.html"),
    ("Wide Metabolic Metric Dataframe", "08_wide_metric_dataframe.html"),
    ("Post Hoc Analysis and Stats", "09_posthoc_analysis.html"),
    ("Tidy Regression Matrix Generation", "10_tidy_regression.html"),
